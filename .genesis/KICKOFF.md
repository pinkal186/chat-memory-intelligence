# KICKOFF — paste this to start or resume a chat-memory-intelligence session cold
...
- data-system-engineering  (storage, pgvector, schema decisions)
- llmops-ai-agents  (LLM extractor, evaluator, RAG, reflection)
- coding-orchestrator            (route before any code)
- modular-architecture  (services boundries, dependency direction)
- production-readiness  (timeouts, circuit breakers, graceful degradation)
- security-engineering (RLS,PPI filter, threat model)
